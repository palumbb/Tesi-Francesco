...
from old.server import get_evalulate_fn, weighted_average
from flwr.server.client_manager import SimpleClientManager
from flwr.common import ndarrays_to_parameters
import torch
from torch.utils.data import DataLoader
from model import BinaryNet, train, evaluate
from servers.server_scaffold import ScaffoldServer
...
def main(cfg: DictConfig):
    ...
    if federated:
        ...
        generate_client_fn = call(cfg.generate_client_fn)
        client_fn = generate_client_fn(trainloaders=trainloaders, 
        ...
        history = fl.simulation.start_simulation(
            server= ScaffoldServer(strategy, model=cfg.model, client_manager=SimpleClientManager()),
            client_fn=client_fn,
