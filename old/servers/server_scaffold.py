...
class ScaffoldServer(Server):
    ...
    def __init__(self, strategy, model, client_manager = None):
    ...
    def _get_initial_parameters(self, timeout) -> Parameters:
...
def gen_evaluate_fn(
    ...
    def evaluate(
        ...
        loss, accuracy = evaluate(net, testloader, device=device)
